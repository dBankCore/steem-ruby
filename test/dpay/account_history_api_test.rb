...
module DPay
  # :nocov:
  class AccountHistoryApiTest < DPay::Test
    def setup
      @api = DPay::AccountHistoryApi.new(url: TEST_NODE)
    ...
    def test_api_class_name
      assert_equal 'AccountHistoryApi', DPay::AccountHistoryApi::api_class_name
    end

    def test_inspect
      assert_equal "#<AccountHistoryApi [@chain=dpay, @methods=<3 elements>]>", @api.inspect
    end
